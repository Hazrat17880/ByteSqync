...
const AdminSidebar = ({ isOpen, toggleSidebar }) => {
  ...
  const menuItems = [
    ...
    { name: 'Students', icon: Users, path: '/admin-dashboard/students' },
    { name: 'Teachers', icon: GraduationCap, path: '/admin-dashboard/teachers' },
    { name: 'Settings', icon: Settings, path: '/admin-dashboard/settings' },
    { name: 'Contact Us', icon: Phone, path: '/admin-dashboard/contact' },
    
      { name: 'Feedbacks', icon: MessageSquare, path: '/admin-dashboard/feedbacks' },
